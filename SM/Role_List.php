...
if(isset($_GET['did']))
    {
        $Id=$_GET['did'];
        $sql = "Delete from role_master where Id=" . $Id;
    ...
    echo'<script type="text/javascript">
        ...
        echo '<script type="text/javascript">
            alert("Role Delete UnSuccessfully");
            window.location.href="role_list.php";
</script>';
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
                            ...
                            echo '<td ><a href="role_Entry.php?cid=' . $row['Id'] . '" ><div class="fonticon-wrap fonticon-container bodyblack" style="font-size:1.5em"><i class="ft-edit" ></i></div></a></td>'; 
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="role_list.php?did=" + tmp;
