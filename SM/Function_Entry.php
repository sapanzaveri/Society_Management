...
$message="";
    ...
    {
        $Function=($_POST['txt_func']);
        $Remark=($_POST['remarks']);
        $hdnId = $_POST['hdnId'];
        if($hdnId==0)
        {
        $sql = "INSERT INTO `function_master`(`Name`,`Remark`) VALUES ('$Function','$Remark')";
        ...
        <script type="text/javascript">
            ...
            window.location.href="Function_Entry.php";
</script>
<?php   
...
if(isset($_GET['cid']))
    {
        $Id = $_GET['cid'];
        $sql = "Select * from function_master where Id=" . $Id;
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-warning">
                        <h4 class="card-title" id="basic-layout-colored-form-control">Function Registration</h4>
                    </div>
                    <p class="mb-0">Function Entry Form.</p>
                </div>
                <div class="card-body">
                    <div class="px-3">

                        <form class="form" action="Function_Entry.php" method="post" enctype="multipart/form-data">
                         <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
                            <div class="form-body">
                                <h4 class="form-section">
                                    <i class="icon-direction"></i> Function Entry</h4>
                                
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Function Name</label>
                                            <input type="text" id="txt_func" name="txt_func" class="form-control round" placeholder="Enter Function Name" value="<?php if($Id<>0) echo $row['Name'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
