...
<!-- Mirrored from pixinvent.com/demo/convex-bootstrap-admin-dashboard-template/demo-1/user-profile-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Sep 2018 10:37:24 GMT -->
<head>
    ...
    <title>User Profile Page - Convex bootstrap 4 admin dashboard template</title>
            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="has-sub nav-item"><a href="#"><i class="icon-docs"></i><span data-i18n="" class="menu-title">Pages</span></a>
                <ul class="menu-content">
                  ...
                  <li class="active"><a href="user-profile-page.html" class="menu-item">User Profile</a>
                  </li>
                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-plane danger font-medium-3"></i> <span class="mt-1 display-block">Travelling</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-speedometer danger font-medium-3"></i> <span class="mt-1 display-block">Driving</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-camera danger font-medium-3"></i> <span class="mt-1 display-block">Photography</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-game-controller danger font-medium-3"></i> <span class="mt-1 display-block">Gaming</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-music-tone-alt danger font-medium-3"></i> <span class="mt-1 display-block">Music</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="ft-monitor danger font-medium-3"></i> <span class="mt-1 display-block">Surfing</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="ft-pie-chart danger font-medium-3"></i> <span class="mt-1 display-block">Foodie</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="ft-tv danger font-medium-3"></i> <span class="mt-1 display-block">TV</span></span>
                                    <span class="col-6 col-md-4 col-xl-6 mt-2 float-left text-center"> <i class="icon-basket-loaded danger font-medium-3"></i> <span class="mt-1 display-block">Shopping</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-block">
                        <div class="row">
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/1.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/2.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/3.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/4.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/5.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/6.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/7.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/8.jpg" alt="Image description" />
                            </figure>
                            <figure class="col-xl-6 col-lg-4 col-sm-6 col-12">
                                <img class="img-thumbnail img-fluid" src="../app-assets/img/gallery/9.jpg" alt="Image description" />
                            </figure>
                        </div>
                    </div>
                </div>
