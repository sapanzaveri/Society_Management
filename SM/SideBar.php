<div data-active-color="white" data-background-color="black" data-image="../app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
        <div class="sidebar-header">
          <div class="logo clearfix">
              ...
              <div class="logo-img"><img src="../app-assets/img/Home.png" alt="Convex Logo"/></div><span class="text align-middle">Society</span></div>
              <a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="ft-disc toggle-icon"></i></a><a id="sidebarClose" href="javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-circle"></i></a>
              </div>
        </div>
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              <li class="nav-item"><a href="Dashboard.php"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              
              </li>
              <li class="has-sub nav-item"><a href="#"><i class="ft-user-plus"></i><font size="1.6">Member Management</font></a>
                <ul class="menu-content">
                  <li><a href="Member_Entry.php" class="menu-item">Member Entry</a>
                  </li>
                  <li><a href="Member_List.php" class="menu-item">Member List</a>
                  </li>
              ...
              <li class="has-sub nav-item"><a href="#"><i class="ft-home"></i><font size="1.6">Flat Management</font></a>
                <ul class="menu-content">
                  ...
                  <li><a href="Flat_list.php" class="menu-item">Flat List</a>
                  </li>
              ...
              <li class="has-sub nav-item"><a href="#"><i class="icon-screen-desktop"></i><font style="font-size: 9px">Support Management</font></a>
                <ul class="menu-content">
                  <li><a href="SupportType_Entry.php" class="menu-item">Support Type Entry</a>
                  </li>
                  <li><a href="SupportType_List.php" class="menu-item">Support Type List</a>
                  </li>
              ...
              <li class="has-sub nav-item"><a href="#"><i class="icon-screen-desktop"></i><font style="font-size: 9px">Function Management</font></a>
                <ul class="menu-content">
                  ...
                  <li><a href="Function_List.php" class="menu-item">Function List</a>
                  </li>
                 
                </ul>
              </li>
              <li class="has-sub nav-item"><a href="#"><i class="icon-screen-desktop"></i><font size="1.6">Role Management</font></a>
                <ul class="menu-content">
                  <li><a href="Role_Entry.php" class="menu-item">Role Entry</a>
                  </li>
                  <li><a href="Role_List.php" class="menu-item">Role List</a>
                  </li>
