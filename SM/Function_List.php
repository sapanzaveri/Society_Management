...
if(isset($_GET['did']))
    {
        $Id=$_GET['did'];
        $sql = "Delete from function_master where Id=" . $Id;
        $res = mysqli_query($link,$sql);
        if($res)
            {
    echo'<script type="text/javascript">
            alert("Function Delete Successfully");
            window.location.href="function_list.php";
</script>';
    }
        else
        
        echo '<script type="text/javascript">
            alert("Function Delete UnSuccessfully");
            window.location.href="function_list.php";
</script>';
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title">Function List</h4>
                    </div>
                </div>
