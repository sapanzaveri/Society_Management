...
if(isset($_GET['did']))
    {
        $Id=$_GET['did'];
        $sql = "Delete from support_type_master where Id=" . $Id;
        $res = mysqli_query($link,$sql);
        if($res)
            {
    echo'<script type="text/javascript">
            alert("Support Type Delete Successfully");
            window.location.href="Supporttype_list.php";
</script>';
    }
        else
        
        echo '<script type="text/javascript">
            alert("Support Type Delete UnSuccessfully");
            window.location.href="Supporttype_list.php";
</script>';
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title">SupportType List</h4>
                    </div>
                </div>
                    ...
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
                            <thead>
                              ...
                              <?php
                            $sql = "SELECT * FROM `support_type_master`";
                            $res = mysqli_query($link,$sql);
                            ...
                            echo '<td ><a href="Supporttype_Entry.php?cid=' . $row['Id'] . '" ><div class="fonticon-wrap fonticon-container bodyblack" style="font-size:1.5em"><i class="ft-edit" ></i></div></a></td>';  
                            echo '<td> <a onclick="javascript:deleteconfig(' . $row['Id'] . ');" ><div class="fonticon-wrap fonticon-container bodyblack" style="font-size:1.5em"><i class="ft-trash-2" style=color:red;>  </i></a></td>';
                            echo '</tr>';
                            }
                                ?>
                         </tbody>
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="SupportType_List.php?did=" + tmp;
