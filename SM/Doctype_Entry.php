...
$message="";
    ...
    if(isset($_POST['btnSubmit']))
    {
        ...
        if($hdnId==0)
        {
        $sql = "INSERT INTO `doc_type`(`Name`,`Remark`) VALUES ('$Doc','$Remark')";
         
        
        }
        else
        {
            $sql="Update doc_type set";
            $sql .= " Name='$Doc', ";
            $sql .= " Remark='$Remark' ";
            $sql .= " Where Id=" . $hdnId;
            $redirect ='Doctype_list.php';
        }
        ...
        <script type="text/javascript">
            ...
            window.location.href="Doctype_Entry.php";
</script>
<?php   
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-warning">
                        <h4 class="card-title" id="basic-layout-colored-form-control">DocType Registration</h4>
                    </div>
                    <p class="mb-0">DocType Entry Form.</p>
                </div>
                <div class="card-body">
                    <div class="px-3">

                        <form class="form" action="Doctype_Entry.php" method="post" enctype="multipart/form-data">
                         <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
                            <div class="form-body">
                                <h4 class="form-section">
                                    <i class="icon-direction"></i> DocType Entry</h4>
                                
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>DocType Name</label>
                                            <input type="text" id="txt_doc" name="txt_doc" class="form-control round" placeholder="Enter DocType Name" value="<?php if($Id<>0) echo $row['Name'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
