...
if(isset($_GET['did']))
	{
		$Id=$_GET['did'];
		$sql = "Delete from flat_master where Id=" . $Id;
		$res = mysqli_query($link,$sql);
		if($res)
			{
	echo'<script type="text/javascript">
			alert("Flat No Unregistered Successfully");
			window.location.href="flat_list.php";
</script>';
	}
		else
		
		echo '<script type="text/javascript">
			alert("Flat No Unregistered unSuccessfully");
			window.location.href="flat_list.php";
</script>';
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
							...
							echo '<td>' . $row['Monthly_Maintenance'] . '</td>';							
							echo '<td ><a href="Flat_Entry.php?cid=' . $row['Id'] . '" >
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Flat_list.php?did=" + tmp;
