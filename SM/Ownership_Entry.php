...
$message="";
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if($hdnId==0)
		{
		$sql = "INSERT INTO `ownership_master`(`Name`,`Remark`) VALUES ('$Ownership','$Remark')";
		 
		
		}
		else
		{
			$sql="Update ownership_master set";
			$sql .= " Name='$Ownership', ";
			$sql .= " Remark='$Remark' ";
			$sql .= " Where Id=" . $hdnId;
			$redirect ='Ownership_list.php';
		}
		...
		<script type="text/javascript">
			...
			window.location.href="Ownership_Entry.php";
</script>
<?php	
...
if(isset($_GET['cid']))
	{
		$Id = $_GET['cid'];
		$sql = "SElect * from ownership_master where Id=" . $Id;
...
<head>
    ...
    <title>Ownership Entry Page </title>
			...
			<div class="card">
				<div class="card-header">
					<div class="card-title-wrap bar-warning">
						<h4 class="card-title" id="basic-layout-colored-form-control">Ownership Registration</h4>
					</div>
					<p class="mb-0">Ownership Entry Form.</p>
				</div>
				<div class="card-body">
					<div class="px-3">

						<form class="form" action="Ownership_Entry.php" method="post" enctype="multipart/form-data">
						 <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
							<div class="form-body">
								<h4 class="form-section">
									<i class="icon-direction"></i> Ownership Entry</h4>
								
									<div class="col-md-6">
										<div class="form-group">
											<label>Ownership Name</label>
											<input type="text" id="txt_name" name="txt_ownership" class="form-control round" placeholder="Enter Ownership Name" value="<?php if($Id<>0) echo $row['Name'] ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
