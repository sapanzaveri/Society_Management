...
if(isset($_GET['did']))
	...
	echo'<script type="text/javascript">
		...
		echo '<script type="text/javascript">
			alert("Event Delete UnSuccessfully");
			window.location.href="Event_list.php";
</script>';
                ...
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
							...
							echo '<td>' . $row['Expected_Budget'] . '</td>';						
							echo '<td>' . $row['IsActive'] . '</td>';							
							echo '<td ><a href="Event_Entry.php?cid=' . $row['Id'] . '" ><i class="fa fa-edit " style="font-size:2.5em;"></i></a></td>';	
							echo '<td> <a onclick="javascript:deleteconfig(' . $row['Id'] . ');" ><i class="fa fa-trash" style=font-size:2.5em;color:red;  text-align: center;>  </i></a></td>';
							echo '</tr>';
							}
								?>
						 </tbody>
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Event_List.php?did=" + tmp;
