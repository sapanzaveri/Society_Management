...
$message="";
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if($hdnId==0)
		{
		$sql = "INSERT INTO `role_master`(`Name`,`Remark`) VALUES ('$Role','$Remark')";
		...
		<script type="text/javascript">
			...
			window.location.href="Role_Entry.php";
</script>
<?php	
...
if(isset($_GET['cid']))
	{
		$Id = $_GET['cid'];
		$sql = "Select * from role_master where Id=" . $Id;
			...
			<div class="card">
				<div class="card-header">
					<div class="card-title-wrap bar-warning">
						<h4 class="card-title" id="basic-layout-colored-form-control">Role Registration</h4>
					</div>
					<p class="mb-0">Role Entry Form.</p>
				</div>
				<div class="card-body">
					<div class="px-3">

						<form class="form" action="Role_Entry.php" method="post" enctype="multipart/form-data">
						 <input type="hidden" name="hdnId" id="hdnId" value="<?php echo $Id; ?>">
							<div class="form-body">
								<h4 class="form-section">
									<i class="icon-direction"></i> Role Entry</h4>
								
									<div class="col-md-6">
										<div class="form-group">
											<label>Role Name</label>
											<input type="text" id="txt_name" name="txt_role" class="form-control round" placeholder="Enter Role Name" value="<?php if($Id<>0) echo $row['Name'] ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
