...
if(isset($_GET['did']))
	{
		$Id=$_GET['did'];
		$sql = "Delete from member_master where Id=" . $Id;
	...
	echo'<script type="text/javascript">
		...
		echo '<script type="text/javascript">
			alert("Member Delete UnSuccessfully");
			window.location.href="member_list.php";
</script>';
                    ...
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
                            <thead>
                              ...
                              <?php
							$sql = "SELECT mm.*, fm.Flat_No as fno , om.Name as oname FROM member_master mm , flat_master fm, ownership_master om";
							$sql .= " where mm.flat_Id=fm.Id";
							$sql .= " AND mm.Ownership_Type=om.Id";
							$sql .= " order by fno";
							...
							echo '<td>' . $row['oname'] . '</td>'; 	
								?>
								 ...
								 <?php
							echo '<td ><a href="Member_Entry.php?cid=' . $row['Id'] . '" >
                                <div class="fonticon-wrap fonticon-container" style="font-size:1.5em"><i class="ft-edit" ></i></div></a></td>';	
							echo '<td> <a onclick="javascript:deleteconfig(' . $row['Id'] . ');" > <div class="fonticon-wrap fonticon-container" style="font-size:1.5em"><i class="ft-trash-2" style=color:red;>  </i></div></a></td>';
							echo '</tr>';
							}
								?>
