...
if(isset($_GET['did']))
    {
        $Id=$_GET['did'];
        $sql = "Delete from doc_type where Id=" . $Id;
        $res = mysqli_query($link,$sql);
        if($res)
            {
    echo'<script type="text/javascript">
            alert("DocType Delete Successfully");
            window.location.href="Doctype_list.php";
</script>';
    }
        else
        
        echo '<script type="text/javascript">
            alert("DocType Delete UnSuccessfully");
            window.location.href="Doctype_list.php";
</script>';
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title">DocType List</h4>
                    </div>
                </div>
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard feather-icons overflow-hidden">
                        ...
                        <table class="table table-striped table-bordered file-export">
                            ...
                            echo '<td ><a href="Doctype_Entry.php?cid=' . $row['Id'] . '" ><div class="fonticon-wrap fonticon-container bodyblack" style="font-size:1.5em"><i class="ft-edit" ></i></div></a></td>';  
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="DocType_list.php?did=" + tmp;
