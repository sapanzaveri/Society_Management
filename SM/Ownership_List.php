...
if(isset($_GET['did']))
	{
		$Id=$_GET['did'];
		$sql = "Delete from ownership_master where Id=" . $Id;
		$res = mysqli_query($link,$sql);
		if($res)
			{
	echo'<script type="text/javascript">
			alert("Ownership Delete Successfully");
			window.location.href="ownership_list.php";
</script>';
	}
		else
		
		echo '<script type="text/javascript">
			alert("Ownership Delete UnSuccessfully");
			window.location.href="ownership_list.php";
</script>';
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title-wrap bar-success">
                        <h4 class="card-title">Ownership List</h4>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                         ...
                         <table class="table table-striped table-bordered file-export">
                            <thead>
                              ...
                              <?php
							$sql = "SELECT * FROM `ownership_master`";
							$res = mysqli_query($link,$sql);
							...
							echo '<td ><a href="ownership_Entry.php?cid=' . $row['Id'] . '" ><i class="fa fa-edit " style="font-size:1.5em;"></i></a></td>';	
							echo '<td> <a onclick="javascript:deleteconfig(' . $row['Id'] . ');" ><i class="fa fa-trash" style=font-size:1.5em;color:red;  text-align: center;>  </i></a></td>';
							echo '</tr>';
							}
								?>
						 </tbody>
	...
	<!---- Record Delete Script ------>  
	  ...
	  <script type="text/javascript">
    	function deleteconfig(tmp)
				...
				if (x==true)
				{
			  	window.location="Ownership_List.php?did=" + tmp;
